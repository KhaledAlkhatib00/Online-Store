...
namespace TUITY_STORE.Controllers
{
    public class OrderProductsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.Productts, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,OrderId,ProductId,Quantity")] OrderProduct orderProduct)
        {
            ...
            ViewData["OrderId"] = new SelectList(_context.Orderrs, "Id", "Id", orderProduct.OrderId);
            ViewData["ProductId"] = new SelectList(_context.Productts, "Id", "Id", orderProduct.ProductId);
            return View(orderProduct);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,OrderId,ProductId,Quantity")] OrderProduct orderProduct)
        {
